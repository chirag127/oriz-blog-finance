...
export const SITE_CONFIG: BlogConfig = {
  title: 'Compound — money notes for India',
  description:
    'Plain, practical money notes for Indian investors and savers. Index funds, credit, tax, and building an emergency fund, explained without the sales pitch.',
  url: 'https://finance-blog.oriz.in',
  defaultLocale: 'en',
  author: {
    name: 'Chirag Singhal',
  ...
  giscus: {
    repo: env('PUBLIC_GISCUS_REPO', 'chirag127/oriz-blog-finance') as `${string}/${string}`,
